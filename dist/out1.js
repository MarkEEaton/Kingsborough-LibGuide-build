...
`], ...formatTraceEntry(entry));
  ...
  function renderComponentRoot(instance) {
    const { type: Component, vnode, proxy, withProxy, props, propsOptions: [propsOptions], slots, attrs, emit: emit2, render: render10, renderCache, data, setupState, ctx, inheritAttrs } = instance;
    let result;
    ...
    try {
      if (vnode.shapeFlag & 4) {
        ...
        result = normalizeVNode(render10.call(proxyToUse, proxyToUse, renderCache, props, setupState, data, ctx));
        fallthroughAttrs = attrs;
      } else {
        const render11 = Component;
        if (attrs === props) {
          markAttrsAccessed();
        }
        result = normalizeVNode(render11.length > 1 ? render11(props, true ? {
          get attrs() {
            markAttrsAccessed();
            return attrs;
          },
          slots,
          emit: emit2
        } : { attrs, slots, emit: emit2 }) : render11(
          props,
          null
...
${codeFrame}` : message);
    ...
    const render10 = new Function("Vue", code)(runtime_dom_esm_bundler_exports);
    render10._rc = true;
  ...
  var _hoisted_1 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode(
    ...
    [
      /* @__PURE__ */ createBaseVNode("span", { id: "corona-alert-text" }, "No fines on KBCC books checked out before the pandemic! Just return them to any CUNY Library.")
    ],
    -1
    /* HOISTED */
  ));
    ...
    [
      /* @__PURE__ */ createBaseVNode("div", {
        ...
        /* @__PURE__ */ createBaseVNode("div", {
          ...
          /* @__PURE__ */ createBaseVNode("div", { class: "modal-body" }, [
            /* @__PURE__ */ createBaseVNode("button", {
              ...
              /* @__PURE__ */ createBaseVNode("span", { "aria-hidden": "true" }, "\xD7")
            ]),
            /* @__PURE__ */ createBaseVNode("h4", {
              class: "modal-title",
              id: "myModalLabel"
            }, " Before returning books to another CUNY library, please make sure you have updated your vaccine information to Cleared4 or checked rules for visiting that campus. ")
          ])
        ])
      ])
    ],
  ...
  function render2(_ctx, _cache) {
    return openBlock(), createElementBlock(
      ...
      [
        ...
        _hoisted_2,
        createCommentVNode(" End of modal ")
      ],
      64
      /* STABLE_FRAGMENT */
    );
  ...
  var _hoisted_15 = /* @__PURE__ */ createBaseVNode(
    ...
    [
      /* @__PURE__ */ createBaseVNode("div", { id: "s-lib-alert-content" })
    ],
    -1
    /* HOISTED */
  );
  var _hoisted_24 = /* @__PURE__ */ createBaseVNode(
    "div",
    {
      id: "s-lib-popover-title",
      class: "hide"
    },
    [
      /* @__PURE__ */ createBaseVNode("span", { class: "text-info" }, [
  ...
  var _hoisted_32 = /* @__PURE__ */ createBaseVNode(
    ...
    [
      /* @__PURE__ */ createBaseVNode("i", { class: "fa fa-refresh fa-spin" }),
      /* @__PURE__ */ createTextVNode(" Loading... "),
      /* @__PURE__ */ createBaseVNode("button", {
        class: "btn btn-default btn-sm popclose",
        type: "button"
      }, "Close")
    ],
    -1
  ...
  var _hoisted_43 = /* @__PURE__ */ createBaseVNode(
    ...
    [
      /* @__PURE__ */ createBaseVNode("span", { class: "fa-stack fa-lg" }, [
        /* @__PURE__ */ createBaseVNode("i", { class: "fa fa-square-o fa-stack-2x" }),
  ...
  var _hoisted_7 = { class: "dropdown-menu fade dropdown-margin" };
  var _hoisted_8 = ["aria-label", "href", "target"];
  var _hoisted_9 = { class: "bigger-fancy-text" };
      ...
      createBaseVNode("div", _hoisted_26, [
        createBaseVNode("ul", _hoisted_33, [
          (openBlock(true), createElementBlock(
            Fragment,
            null,
            renderList($data.navListOfMenus, (navmenu, navkey) => {
      ...
      submitSearch() {
        if (this.displayedItem === "Define Your Search") {
          ...
          if (!this.$refs.blueBorder1.classList.contains("open")) {
            this.$refs.oneSearchMenu.click();
          }
        } else {
          this.$refs.primoQueryString.value = `any,contains,${this.$refs.primoQueryTempString.value.replace(/[,]/g, " ")}`;
          this.$refs.oneSearchForm.submit();
        }
      }
    },
    data() {
      return {
        selectedItem: {},
        // initialize the data from the dropdown selection
        searchString: "",
        // initialize an empty search string
        placeholderString: "Enter search term here",
        // initialize the placeholder
        displayedItem: "Define Your Search",
        // the text displayed a the top of the OneSearch dropdown
        materialType: {
          Books: {
            fullName: "Books",
  ...
  var _hoisted_142 = /* @__PURE__ */ _withScopeId4(() => /* @__PURE__ */ createBaseVNode(
    ...
    { id: "onesearch-header" },
    [
      /* @__PURE__ */ createBaseVNode("a", { href: "https://cuny-kb.primo.exlibrisgroup.com/discovery/search?tab=Everything&vid=01CUNY_KB:CUNY_KB&lang=en" }, [
  ...
  var _hoisted_162 = {
    class: "dropdown input-group zero-margin",
    id: "blue-border1",
    ref: "blueBorder1"
  };
  var _hoisted_172 = {
  ...
  var _hoisted_232 = /* @__PURE__ */ _withScopeId4(() => /* @__PURE__ */ createBaseVNode(
    ...
    [
      /* @__PURE__ */ createBaseVNode("div", { class: "highlight-menu-item bigger-fancy-text" }, [
        /* @__PURE__ */ createBaseVNode("strong", null, "Advanced Search")
      ])
    ],
    -1
    /* HOISTED */
  ...
  var _hoisted_252 = {
    class: "input-group zero-margin form-width",
    id: "blue-border2"
  };
  var _hoisted_262 = ["placeholder"];
  var _hoisted_272 = {
    class: "input-group zero-margin",
    id: "blue-border3"
  };
  function render9(_ctx, _cache, $props, $setup, $data, $options) {
    return openBlock(), createElementBlock("form", {
      ...
      role: "search",
      method: "get",
      action: $data.selectedItem.baseUrl,
      enctype: "application/x-www-form-urlencoded; charset=utf-8"
    }, [
      createCommentVNode(' default is "everything"  option suggested from OLS widget builder '),
      $data.selectedItem.input ? (openBlock(), createElementBlock("div", {
        key: 0,
      ...
      createBaseVNode("div", _hoisted_152, [
            ...
            createBaseVNode(
              ...
              [
                createBaseVNode(
                  "span",
                  _hoisted_182,
                  toDisplayString($data.displayedItem) + "\xA0",
                  1
                  /* TEXT */
                ),
                _hoisted_19
            ...
            createBaseVNode("ul", _hoisted_20, [
              createBaseVNode("li", null, [
                (openBlock(true), createElementBlock(
                  Fragment,
                  null,
                  renderList($data.materialType, (item, itemName) => {
                    return openBlock(), createElementBlock("a", {
                      key: item.id,
                      class: "searchmenu",
                      onClick: ($event) => $options.selectDropdown(item, itemName)
                    }, [
        ...
        createBaseVNode("div", _hoisted_252, [
          withDirectives(createBaseVNode("input", {
            ...
            type: "search",
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => $data.searchString = $event),
            placeholder: $data.placeholderString
          }, null, 8, _hoisted_262), [
            [vModelText, $data.searchString]
          ])
        ]),
        createBaseVNode("div", _hoisted_272, [
          createBaseVNode("input", {
            ...
            value: "Search",
            onClick: _cache[1] || (_cache[1] = withModifiers((...args) => $options.submitSearch && $options.submitSearch(...args), ["stop", "prevent"]))
          })
        ])
      ])
    ], 8, _hoisted_18);
  ...
  var app1 = createApp({
    components: {
      "alert-component": alert_component_default,
  ...
  var app2 = createApp({
    components: {
      "links-component": links_component_default
    }
  }).mount("#app2");
  var app3 = createApp({
    components: {
      "foot-component": foot_component_default,
      "lg-foot-component": lg_foot_component_default
    }
  }).mount("#app3");
})();
